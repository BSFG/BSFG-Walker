...
**Num6 -** отдельная специальная кнопка, которая юзается только тогда, когда уровень MP персонажа < 15%
...
Макросы создаем следующим образом:

1. Макрос для переключения между целями заменяем на команду /Nextmonster
...
![Farm](https://raw.githubusercontent.com/BSFG/BSFG-Walker/master/EW-Walker/v%201.0/farm%20macros.PNG)
...
![Mode1](https://raw.githubusercontent.com/BSFG/BSFG-Walker/master/EW-Walker/v%201.0/2.PNG)
...
![Mode2](https://raw.githubusercontent.com/BSFG/BSFG-Walker/master/EW-Walker/v%201.0/1.PNG)
...
![Mode3](https://raw.githubusercontent.com/BSFG/BSFG-Walker/master/EW-Walker/v%201.0/3.PNG)


Также можно на 4-5, Num4-Num5 установить команду /Nextmonster для более быстрого переключения при убийстве моба
...
### Поддержка ОС ниже Windows 8 не гарантируется, но на 7 работает
