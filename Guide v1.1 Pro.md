...
Теперь есть возможность при таргете на персонажа бить его, а не только переключаться на моба. Для работы данной функции необходимо раскрыть данную панель
